...
public class AndroidRss extends Activity {
    ...
    public void onCreate ( Bundle savedInstanceState ) {
        ...
        goButton.setOnClickListener ( new OnClickListener ( ) {
            ...
            public void onClick ( View v ) {
                ...
                new RssGetter ( ).doInBackground ( rss );
            }
        } );
        ...
        goDefaultButton.setOnClickListener ( new OnClickListener ( ) {
            @Override
            public void onClick ( View v ) {
                new RssGetter ( ).doInBackground ( getString ( R.string.default_feed ) );
            }
        } );
     ...
     */
    private class RssGetter extends AsyncTask < String, Void, List <  > > {
